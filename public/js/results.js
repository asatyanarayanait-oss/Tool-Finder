...
class ResultsAnimationController {
    ...
    createComparisonModal(recommendations) {
        ...
        requestAnimationFrame(() => {
            ...
            if (typeof modalContent.scrollIntoView === 'function') {
    ...
    setupScrollAnimations() {
        ...
        document.querySelectorAll('.recommendation-card, .scroll-reveal').forEach(element => {
...
function displayRecommendations(data) {
    ...
    notesElement.className = 'bg-orange-900 bg-opacity-30 border-2 border-orange-500 backdrop-blur-sm p-6 mt-6 rounded-lg fade-in scroll-reveal shadow-lg';
    ...
    console.log('Additional notes content before processing:', additionalContent);
    ...
    console.log('Final additional content:', additionalContent);
        ...
        <div class="flex items-start">
            ...
            <div class="flex-1">
                ...
                <div class="grid md:grid-cols-3 gap-4 mt-4">
                    <div class="bg-orange-800 bg-opacity-20 p-3 rounded-lg border border-orange-600 border-opacity-30">
